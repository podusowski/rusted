...
TEST_F(TmsTest, Read)
{
    ...
    EXPECT_EQ(1u, tms.getValue<unsigned>("variable1"));
    EXPECT_EQ(2u, tms.getValue<unsigned>("variable2"));
...
TEST_F(TmsTest, CopyCtor)
{
    ...
    EXPECT_EQ(1u, tms1.getValue<unsigned>("variable1"));
}
...
TEST_F(TmsTest, Assign)
{
    ...
    Cake::Serialization::Tms tms2 = tms1;
    EXPECT_EQ(1u, tms2.getValue<unsigned>("variable1"));

    Cake::Serialization::Tms tms3;
    EXPECT_ANY_THROW(tms3.getValue<unsigned>("variable1"));
    tms3 = tms1;
    EXPECT_EQ(1u, tms3.getValue<unsigned>("variable1"));
}
