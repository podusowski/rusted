...
TEST_F(ActionFactoryTest, BuildAttack)
{
    ...
    Server::Game::Actions::ActionParameters actionParameters = { PLAYER_ID, ATTACK_ID, ATTACK_PARAMETER, 1, 2 };
    auto attackAction = factory.create(connection, player, actionParameters);
